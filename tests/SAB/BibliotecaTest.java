...
import src.SAB.AdicionarLivroInexistenteException;
import src.SAB.Biblioteca;
import src.SAB.BuscaUsuarioComNomeNuloException;
import src.SAB.BuscaUsuarioComNomeVazioException;
import src.SAB.DevolveLivroDisponivelParaEmprestimoException;
import src.SAB.DevolveLivroNuloParaEmprestimoException;
import src.SAB.Livro;
import src.SAB.LivroIndisponivelParaEmprestimoException;
import src.SAB.LivroOuUsuarioNulosException;
import src.SAB.TituloOuAutorNuloException;
import src.SAB.TituloOuAutorVazioException;
import src.SAB.Usuario;
import src.SAB.UsuarioComNomeVazioException;
import src.SAB.UsuarioInexistenteException;
import src.SAB.UsuarioJaRegistradoException;
...
public class BibliotecaTest {
	...
	public void whenBuscoLivroPeloNrCatalogoEntaoRetornoLivroCujoNrCatalogoConfere() {
		...
		Livro livro = biblioteca.buscaLivroPorNumeroCatalogo(2);
		assertEquals(2, livro.getNumeroCatalogo());
	}

	@Test
	public void whenBuscoLivroPeloNrCatalogoInexistenteEntaoLivroEhNulo() {
		// T22: Busca livro por NrCatalogo inexistente: 0 e 5
		Livro livroHum = biblioteca.buscaLivroPorNumeroCatalogo(0);
		Livro livroDois = biblioteca.buscaLivroPorNumeroCatalogo(5);
	...
	public void whenBuscoLivroPorTituloEAutorEntaoRetornoLivroCujoTituloEAutorConfere()
		...
		Livro livroTres = biblioteca.buscaLivroPorTituloAutor(
				"Using CRC Cards", "Nancy Wilkinson");
		assertEquals(3, livroTres.getNumeroCatalogo());

		Livro livroHum = biblioteca.buscaLivroPorTituloAutor(
				"Java Design Patterns", "Pankaj Kumar");
		assertEquals(1, livroHum.getNumeroCatalogo());
	}
